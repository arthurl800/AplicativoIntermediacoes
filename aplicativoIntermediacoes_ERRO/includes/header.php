...
<head>
    ...
    <!-- 1. INCLUSÃO DO TAILWIND CSS PARA ESTILIZAÇÃO MODERNA -->
    ...
    <style>
        ...
        /* ESTILOS LEGADOS DO SEU ARQUIVO (Mantidos para compatibilidade) */
        html, body { 
            height: 100%; 
            margin: 0; 
            /* font-family: Arial, sans-serif; - Removido para usar Inter */
        ...
        /* Ajustei o main para usar classes Tailwind, mas mantive o estilo base */
        main { 
            padding: 20px; 
            max-width: 1200px; 
            margin: 20px auto; 
        ...
        /* Estilos de Tabela Legados (devem ser substituídos pelas classes Tailwind na view) */
        .data-table {
            width: 100%;
